    ...
    <script>
        ...
        function populateDropzone(){
            ...
            for (var i = 0; i < icons.length; i += 1) {
                ...
                var name = names[i];
                var thissize = size[i];
                $("#dropzone").append( '<div class="dropzonefileiconst">' + '<img src=' + icon + " height=90px;" + '>' + '<br style="line-height:34px"><span style="font-size:18px">' + name + '</span><br style="line-height:26px">' + '<span style="font-size:18px">' + thissize + ' kb' + '</span>' + '<br style="line-height:24px"></div>');
            }
...
<!---- -------------------------------->
            ...
            <div id="file-info-accordions" >
                    ...
                    <div class=third>
                        ...
                        <img src='icons-misc/panels/play.png' width=20% style='margin-bottom:30px'></img>
                        <br>
                    ...
                    <div id="myModal" class="modal ">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h3 style="margin-bottom:10px">Select files to convert:</h3>
                                    ...
                                    <div id=selectFileTypes style='display:none;'>
                                        <h3 style="margin-bottom:10px">Select conversion types:</h3>
                                        ...
                                        <div id=filetypeselectionsection class=selectionSection>
                                            ...
                                            <div id=krnDownloadIcon class="filetypeDownload unselected" onclick="addSelectedClass(this.id)">
